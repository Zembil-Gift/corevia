...
const heading = {
  eyebrow: { en: "FAQ", am: "ተደጋጋሚ ጥያቄዎች" },
  title: { en: "Questions, answered", am: "ጥያቄዎች፣ ተመልሰዋል" },
}
...
const faqs = {
  ...
  am: [
    ...
    },
    {
      ...
      a: "አዎ። ስራዎችዎ፣ ብሎግ ጽሁፎችዎ እና ዝግጅቶችዎ ለድርጅትዎ በህዝብ ገጾች ላይ ይታያሉ፣ ስለዚህ አመልካቾች እና አንባቢዎች ያለ መለያ ማየት ይችላሉ።",
    },
    {
    ...
    },
    {
      ...
      a: "ለ31 ቀናት ያለ ክሬዲት ካርድ ሙሉ መዳረሻ ይኖርዎታል። ዝግጁ ሲሆኑ ዕቅድ ይምረጡ፤ ምንም በራስ-ሰር አይከፈልም።",
    },
  ],
}
